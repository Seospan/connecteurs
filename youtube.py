...
##penser à activer les api dans la console google
##token 1h qui se renouvelle automatiquement
...
CLIENT_SECRETS_FILE = 'lib/ganalytics/medisup/client_secret_46449833970-8pdlpgkuufse19s0arhknr1sdrlbccb1.apps.googleusercontent.com.json'
...
def get_authenticated_service(args):
  ...
  #sys.argv[0] contains script name ( E:/Sophie/Gitkraken/connecteurs/youtube.py )
...
# === if used as standalone program (if not, __name__ == name of module)
if __name__ == "__main__":
  # returns namespace ( Namespace(auth_host_name='localhost', auth_host_port=[8080, 8090], logging_level='ERROR', noauth_local_webserver=False) )
  args = argparser.parse_args()
  print(args)
  youtube_reporting = get_authenticated_service(args)
  #print(youtube_reporting)
  try:
